...
%\begin{multicols*}{2} 			
\input{vs-solving-problems-on-linear-inequalities-in-two-variables-input}
\input{ps-solving-problems-on-linear-inequalities-in-two-variables-input1}
\input{ps-solving-problems-on-linear-inequalities-in-two-variables-input2}	
%\end{multicols*} 
