...
%\begin{multicols*}{2} 			
\input{vs-calculating-probability-of-simple-combined-events-input}
\input{ps-calculating-probability-of-simple-combined-events-input1}
\input{ps-calculating-probability-of-simple-combined-events-input2}	
%\end{multicols*} 
