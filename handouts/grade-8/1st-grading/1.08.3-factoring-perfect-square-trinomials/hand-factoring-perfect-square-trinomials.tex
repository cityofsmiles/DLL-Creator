...
%\begin{multicols*}{2} 			
\input{vs-factoring-perfect-square-trinomials-input}
\input{ps-factoring-perfect-square-trinomials-input1}
\input{ps-factoring-perfect-square-trinomials-input2}	
%\end{multicols*} 
