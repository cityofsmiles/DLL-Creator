...
%\begin{multicols*}{2} 			
\input{vs-solving-financial-problems-involving-earning-money-input}
\input{ps-solving-financial-problems-involving-earning-money-input1}
\input{ps-solving-financial-problems-involving-earning-money-input2}	
%\end{multicols*} 
