...
%\begin{multicols*}{2} 			
\input{vs-solving-a-system-of-linear-equations-by-graphing-input}
\input{ps-solving-a-system-of-linear-equations-by-graphing-input1}
\input{ps-solving-a-system-of-linear-equations-by-graphing-input2}	
%\end{multicols*} 
