...
%\begin{multicols*}{2} 			
\input{vs-modeling-real-life-situations-with-algebraic-expressions-input}
\input{ps-modeling-real-life-situations-with-algebraic-expressions-input1}
\input{ps-modeling-real-life-situations-with-algebraic-expressions-input2}	
%\end{multicols*} 
