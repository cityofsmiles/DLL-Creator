...
%\begin{multicols*}{2} 			
\input{vs-finding-the-volumes-of-cones-and-spheres-input}
\input{ps-finding-the-volumes-of-cones-and-spheres-input1}
\input{ps-finding-the-volumes-of-cones-and-spheres-input2}	
%\end{multicols*} 
