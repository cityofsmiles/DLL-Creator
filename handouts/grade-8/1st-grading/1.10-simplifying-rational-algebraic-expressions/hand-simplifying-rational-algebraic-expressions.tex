...
%\begin{multicols*}{2} 			
\input{vs-simplifying-rational-algebraic-expressions-input}
\input{ps-simplifying-rational-algebraic-expressions-input1}
\input{ps-simplifying-rational-algebraic-expressions-input2}	
%\end{multicols*} 
