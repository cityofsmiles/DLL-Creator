...
\begin{enumerate}
%    \item In a right triangle, one angle is \(30^\circ\) and the hypotenuse is 10 units. Find the lengths of the opposite and adjacent sides.
    ...
    % \item A triangle has a \(30^\circ\) angle, and the adjacent side is 4 units. Find the hypotenuse and opposite side.
    % \item A triangle has a \(45^\circ\) angle, and the hypotenuse is \(10\sqrt{2}\) units. Find the lengths of the opposite and adjacent sides.
    % \item In a right triangle, one angle is \(60^\circ\) and the opposite side is \(5\sqrt{3}\) units. Find the hypotenuse and adjacent side.
    % \item A triangle has a \(30^\circ\) angle, and the hypotenuse is \(6\sqrt{2}\) units. Find the lengths of the opposite and adjacent sides.
\end{enumerate}
