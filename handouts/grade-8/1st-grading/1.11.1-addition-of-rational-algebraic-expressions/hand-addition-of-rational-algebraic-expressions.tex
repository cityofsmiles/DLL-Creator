...
%\begin{multicols*}{2} 			
\input{vs-addition-of-rational-algebraic-expressions-input}
\input{ps-addition-of-rational-algebraic-expressions-input1}
\input{ps-addition-of-rational-algebraic-expressions-input2}	
%\end{multicols*} 
