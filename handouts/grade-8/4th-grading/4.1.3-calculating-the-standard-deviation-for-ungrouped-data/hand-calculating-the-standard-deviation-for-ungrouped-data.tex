...
%\begin{multicols*}{2} 			
\input{vs-calculating-the-standard-deviation-for-ungrouped-data-input}
\input{ps-calculating-the-standard-deviation-for-ungrouped-data-input1}
\input{ps-calculating-the-standard-deviation-for-ungrouped-data-input2}	
%\end{multicols*} 
