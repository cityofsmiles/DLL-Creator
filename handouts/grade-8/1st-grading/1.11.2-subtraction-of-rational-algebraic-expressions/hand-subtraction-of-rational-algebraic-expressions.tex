...
%\begin{multicols*}{2} 			
\input{vs-subtraction-of-rational-algebraic-expressions-input}
\input{ps-subtraction-of-rational-algebraic-expressions-input1}
\input{ps-subtraction-of-rational-algebraic-expressions-input2}	
%\end{multicols*} 
