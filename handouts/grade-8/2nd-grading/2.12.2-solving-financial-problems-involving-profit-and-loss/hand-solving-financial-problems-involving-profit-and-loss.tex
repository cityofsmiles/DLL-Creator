...
%\begin{multicols*}{2} 			
\input{vs-solving-financial-problems-involving-profit-and-loss-input}
\input{ps-solving-financial-problems-involving-profit-and-loss-input1}
\input{ps-solving-financial-problems-involving-profit-and-loss-input2}	
%\end{multicols*} 
