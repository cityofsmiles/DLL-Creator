...
%\begin{multicols*}{2} 			
\input{vs-solving-problems-on-volume-of-cones-and-spheres-input}
\input{ps-solving-problems-on-volume-of-cones-and-spheres-input1}
\input{ps-solving-problems-on-volume-of-cones-and-spheres-input2}	
%\end{multicols*} 
