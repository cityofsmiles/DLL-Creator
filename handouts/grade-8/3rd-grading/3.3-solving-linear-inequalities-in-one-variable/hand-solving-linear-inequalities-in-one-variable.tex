...
%\begin{multicols*}{2} 			
\input{vs-solving-linear-inequalities-in-one-variable-input}
\input{ps-solving-linear-inequalities-in-one-variable-input1}
\input{ps-solving-linear-inequalities-in-one-variable-input2}	
%\end{multicols*} 
