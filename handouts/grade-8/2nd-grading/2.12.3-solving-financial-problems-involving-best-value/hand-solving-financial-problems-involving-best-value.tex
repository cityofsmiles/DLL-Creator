...
%\begin{multicols*}{2} 			
\input{vs-solving-financial-problems-involving-best-value-input}
\input{ps-solving-financial-problems-involving-best-value-input1}
\input{ps-solving-financial-problems-involving-best-value-input2}	
%\end{multicols*} 
