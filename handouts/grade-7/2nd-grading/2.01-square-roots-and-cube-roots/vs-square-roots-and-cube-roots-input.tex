...
\(x\) = radicand \quad 2 = index \quad \(\sqrt{\phantom{5}}\) = radicand sign \quad \(y\) = square root of \(x\) 
 ...
 \(x\) = radicand \quad 3 = index \quad \(\sqrt{\phantom{5}}\) = radicand sign \quad \(z\) = cube root of \(x\) 
