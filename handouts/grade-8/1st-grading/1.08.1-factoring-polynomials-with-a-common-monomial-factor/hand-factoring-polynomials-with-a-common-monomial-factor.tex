...
%\begin{multicols*}{2} 			
\input{vs-factoring-polynomials-with-a-common-monomial-factor-input}
\input{ps-factoring-polynomials-with-a-common-monomial-factor-input1}
\input{ps-factoring-polynomials-with-a-common-monomial-factor-input2}	
%\end{multicols*} 
