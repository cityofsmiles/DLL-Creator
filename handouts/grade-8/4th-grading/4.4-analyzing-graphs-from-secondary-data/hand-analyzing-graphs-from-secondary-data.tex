...
%\begin{multicols*}{2} 			
\input{vs-analyzing-graphs-from-secondary-data-input}
\input{ps-analyzing-graphs-from-secondary-data-input1}
\input{ps-analyzing-graphs-from-secondary-data-input2}	
%\end{multicols*} 
