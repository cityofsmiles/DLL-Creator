...
%\begin{multicols*}{2} 			
\input{vs-sketching-the-graph-of-a-linear-equation-given-two-points-input}
\input{ps-sketching-the-graph-of-a-linear-equation-given-two-points-input1}
\input{ps-sketching-the-graph-of-a-linear-equation-given-two-points-input2}	
%\end{multicols*} 
