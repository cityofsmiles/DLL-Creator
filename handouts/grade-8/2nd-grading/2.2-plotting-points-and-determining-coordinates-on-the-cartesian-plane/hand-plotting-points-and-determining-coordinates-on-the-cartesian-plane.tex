...
%\begin{multicols*}{2} 			
\input{vs-plotting-points-and-determining-coordinates-on-the-cartesian-plane-input}
\input{ps-plotting-points-and-determining-coordinates-on-the-cartesian-plane-input1}
\input{ps-plotting-points-and-determining-coordinates-on-the-cartesian-plane-input2}	
%\end{multicols*} 
