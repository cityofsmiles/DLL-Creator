...
%\begin{multicols*}{2} 			
\input{vs-multiplication-of-rational-algebraic-expressions-input}
\input{ps-multiplication-of-rational-algebraic-expressions-input1}
\input{ps-multiplication-of-rational-algebraic-expressions-input2}	
%\end{multicols*} 
