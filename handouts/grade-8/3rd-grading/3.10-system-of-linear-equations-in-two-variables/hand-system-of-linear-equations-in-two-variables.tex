...
%\begin{multicols*}{2} 			
\input{vs-system-of-linear-equations-in-two-variables-input}
\input{ps-system-of-linear-equations-in-two-variables-input1}
\input{ps-system-of-linear-equations-in-two-variables-input2}	
%\end{multicols*} 
