...
%\begin{multicols*}{2} 			
\input{vs-factoring-polynomials-as-difference-of-two-squares-input}
\input{ps-factoring-polynomials-as-difference-of-two-squares-input1}
\input{ps-factoring-polynomials-as-difference-of-two-squares-input2}	
%\end{multicols*} 
